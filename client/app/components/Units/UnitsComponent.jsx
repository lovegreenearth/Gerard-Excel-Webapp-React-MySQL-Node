...
class UnitsComponent extends React.Component {
  ...
  componentDidMount() {
    ...
    if(current < expIn) {
      console.log("true:", expIn, current)
      if(token == null) {
  ...
  updateUnit() {
    ...
    let id = this.state.units[index].id;
  ...
  deleteUnit(index) {
    const id = this.state.units[index].id;
  ...
  render() {
    ...
    const cabinetList = cabinets.map(cabinet => {
        return (
            <option key={cabinet.id} value={cabinet.id}>{cabinet.cabinet_name}</option>
        );
    });
        ...
        <div className="container-fluid">
          ...
          > 
            <div className="modal-dialog">
              <div className="modal-content">
                <div className="modal-header">
                  <h5 className="modal-title">You can change unit information here.</h5>
                </div>
                <div className="modal-body">
                <form>
                <div className="input-group">
